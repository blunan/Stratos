...
${OBJECTDIR}/application-helper.o: application-helper.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/application-helper.o application-helper.cc
...
${OBJECTDIR}/neighborhood-application.o: neighborhood-application.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/neighborhood-application.o neighborhood-application.cc

${OBJECTDIR}/ontology-application.o: ontology-application.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ontology-application.o ontology-application.cc

${OBJECTDIR}/position-application.o: position-application.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/position-application.o position-application.cc

${OBJECTDIR}/results-application.o: results-application.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/results-application.o results-application.cc
...
${OBJECTDIR}/search-application.o: search-application.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/search-application.o search-application.cc

${OBJECTDIR}/search-error-header.o: search-error-header.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/search-error-header.o search-error-header.cc

${OBJECTDIR}/search-request-header.o: search-request-header.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/search-request-header.o search-request-header.cc

${OBJECTDIR}/search-response-header.o: search-response-header.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/search-response-header.o search-response-header.cc

${OBJECTDIR}/service-application.o: service-application.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/service-application.o service-application.cc

${OBJECTDIR}/service-error-header.o: service-error-header.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/service-error-header.o service-error-header.cc

${OBJECTDIR}/service-request-response-header.o: service-request-response-header.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/service-request-response-header.o service-request-response-header.cc

${OBJECTDIR}/stratos.o: stratos.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stratos.o stratos.cc

${OBJECTDIR}/type-header.o: type-header.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/type-header.o type-header.cc

${OBJECTDIR}/utilities.o: utilities.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utilities.o utilities.cc
